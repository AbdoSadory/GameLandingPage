  ...
  return (
    <footer>
      <div className={`${styles.footer_top}`}>
        <a
          href="#"
          className={`${styles.footer_top_anchor} text-decoration-none text-uppercase hide-title`}
      ...
      <div className={`${styles.footer_bottom}`} id="footer_bottom">
        <div className={`${styles.footer_bottom_social_container}`}>
          <a
            className={`${styles.footer_bottom_social_container_anchor} text-decoration-none me-3 hide-title`}
            title="twitter"
            href="#"
            target="_blank"
          >
            <svg className width={20} height={20} viewBox="0 0 16.67 13.54">
              <title>twitter</title>
          ...
          <a
            ...
            target="_blank"
          >
            <svg className width={20} height={20} viewBox="0 0 13.26 13.3">
          ...
          <a
            ...
            target="_blank"
          >
            <svg className width={20} height={20} viewBox="0 0 15 15">
          ...
          <a
            ...
            target="_blank"
          >
            <svg className width={20} height={20} viewBox="0 0 13.33 15.21">
              <title>discord</title>
        ...
        <div className={`${styles.footer_bottom_logos_container}`}>
          <a
            href="#"
            target="_blank"
            className={`${styles.footer_bottom_logos_container_anchor} text-decoration-none hide-title`}
            title="Riot Games"
          >
            <img
        ...
        <div className={`${styles.footer_bottom_terms_container}`}>
          <div>
            <a
              href="#"
              className={`${styles.footer_bottom_terms_container_anchor} text-decoration-none text-uppercase hide-title`}
